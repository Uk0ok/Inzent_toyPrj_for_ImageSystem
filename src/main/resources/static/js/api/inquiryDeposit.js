$(function() {
	...
	$(document).on('click', '.sendToykeyToModal', function() {
		...
		$.ajax({
			url: '/toy/inquiry/inquiryDeposit',
			method: 'POST',
	...
	$('#searchButton').on('click', function() {
		...
		AjaxUtil.ajax("/toy/inquiry/inquiryDeposit", "POST", depositJson, success, error, true);
	})
	...
	$(document).on('click', 'ul.pagination li.page-item', function() {
		...
		AjaxUtil.ajax("/toy/inquiry/inquiryDeposit?page=" + page, "POST", depositJson, success, error, true);
