$(function() {
	...
	$(document).on('click', '.sendToykeyToModal', function() {
		...
		$.ajax({
			...
			error: function(error, request) {
				console.log('sendToykeyToModal error');
			}
		  });
	});
	...
	$('#searchButton').on('click', function() {
		...
		AjaxUtil.ajax("/toy/inquiry/inquiryCommon", "POST", commonJson, success, error, true);
	})
	...
	$(document).on('click', 'ul.pagination li.page-item', function() {
		...
		AjaxUtil.ajax("/toy/inquiry/inquiryCommon?page=" + page, "POST", commonJson, success, error, true);
